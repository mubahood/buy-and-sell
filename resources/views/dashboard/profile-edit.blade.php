...
@section('content')
    ...
    <section class="adpost-part">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <form method="POST" action="{{ url('profile-edit/'.$user_id) }}" enctype="multipart/form-data" class="adpost-form">
                        @csrf
                        ...
                        <div class="adpost-card">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group"><label for="services"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group"><label for="longitude"
                                            class="form-label">Longitude</label>
                                        <input type="text" value="{{ old('longitude') }}" name="longitude" id="longitude"
                                            minlength="2" class="form-control">
                                        @error('longitude')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="form-group"><label for="latitude" class="form-label">Latitude
                                            number</label>
                                        <input type="text" value="{{ old('latitude') }}" id="latitude" name="latitude"
                                            minlength="2" class="form-control">
                                        @error('latitude')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group"><label for="facebook"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group"><label for="division"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group"><label for="whatsapp"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group"><label for="instagram"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group"><label for="linkedin"
